/*
 *  kernel_cfg.c
 *  Wed May 27 15:43:32 2015
 *  SG Version 2.00
 *  sg ./movement.oil -os=ECC2 -I/usr/local/mindstorms/nxtOSEK/toppers_osek/sg/impl_oil -template=/usr/local/mindstorms/nxtOSEK/toppers_osek/sg/lego_nxt.sgt
 */
